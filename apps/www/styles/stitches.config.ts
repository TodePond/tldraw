...
const { styled, globalCss, createTheme, getCssText } = createStitches({
  ...
  theme: {
    ...
    fonts: {
      ui: '"Rosario", system-ui, sans-serif',
      body: '"Rosario", system-ui, sans-serif',
...
const dark = createTheme({
  colors: {
    brushFill: 'rgba(242, 245, 247, 0.5)',
    brushStroke: 'rgba(242, 245, 247, 0.25)',
    brushDashStroke: 'rgba(242, 245, 247, 0.6)',
    hint: '#f2f5f7',
    selected: '#4680ff',
    bounds: '#4680ff',
    boundsBg: 'rgba(70, 128, 255, 0.05)',
    highlight: 'rgba(70, 128, 255, 0.15)',
    overlay: 'rgba(0, 0, 0, 0.15)',
    overlayContrast: 'rgba(255, 255, 255, 0.15)',
    border: '#171d28',
    canvas: '#171d28',
    ...
    tooltip: '#171d28',
    tooltipContrast: '#ffffff',
    codeHl: 'rgba(159, 174, 204, .15)',
    lineError: 'rgba(255, 67, 70, .1)',
  },
  shadows: {
